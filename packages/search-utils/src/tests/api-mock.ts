/**
 *
 * Copied from '@iconify/core/src/api/modules/mock.ts' with few changes to types
 *
 */
import type { IconifyAPIQueryParams, IconifyAPIModule } from 'iconify-icon';
...
// Shenanigans to get IconifyAPIIconsQueryParams type
const iconsQuery: IconifyAPIQueryParams = {
	type: 'icons',
	provider: '',
	prefix: '',
	icons: [],
};
type IconifyAPIIconsQueryParams = typeof iconsQuery;
...
export const mockAPIModule: IconifyAPIModule = {
	 ...
	 * Load icons
	 */
	send: (host: string, params: IconifyAPIQueryParams, queryCallback) => {
