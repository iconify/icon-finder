...
describe('Testing Vue 3 offline code samples', () => {
	const docs: IconifyCodeDocs = {
		type: 'vue',
		href: docsBase + 'vue/',
	};
	const installCode = `npm install --save-dev ${getComponentInstall('vue3')}`;
	const importCode = `import { Icon } from '${componentPackages.vue3.name}';`;
